...
当前项目是个人学习与技术验证用途的 PoC。示例工单和训练数据以合成、脱敏数据为主；公开数据来源、许可证和使用边界见[数据卡](docs/data/data-card-v1.md)及 ml/data/source_manifest.json。接入真实企业数据前，需要获得授权并完成脱敏、访问控制和保留策略评审。
